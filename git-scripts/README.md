...
The script ensures **at least 1 commit per day**:

- **Fewer commits than days**: 1 commit per day, unused days are skipped
  - Example: 2 commits across 3 days → commits on day 1 and day 2 only

- **More commits than days**: After placing 1 commit per day, remaining commits cycle back to the start
  - Example: 8 commits across 5 days → days 1-3 get 2 commits each, days 4-5 get 1 commit each

## Features

- **UK Date Format** - DD-MM-YYYY
- **Smart Parameter Detection** - Automatically detects if second parameter is a date or number
- **Circular Distribution** - At least 1 commit per day, extras cycle from start
...
- **Distribution:** At least 1 commit per day, extras cycle from start
...
2. Run from the git-scripts directory or add to PATH
